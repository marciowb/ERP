inherited frmLst_TipoContrato: TfrmLst_TipoContrato
  ...
  inherited Panel1: TPanel
    ...
    inherited Panel3: TPanel
      ...
      object edtLayoutTipoContrato: TEditPesquisa
        Left = 16
        Top = 112
        Width = 65
        Height = 21
      ...
      object grpRegra: TDBRadioGroup
        Left = 16
        Top = 139
        Width = 265
        Height = 94
        Caption = ' Regra de quebra de contrato '
        Columns = 2
        DataField = 'FLAGREGRAQUEBRA'
        DataSource = DataCadastro
        Items.Strings = (
          'Nao faz nada'
          'Parc. faltantes+multa'
          'Parcelas faltantes')
        ...
        Values.Strings = (
          ...
          'P'
          'M')
        OnChange = grpRegraChange
      end
      object edtMulta: TLabelDBEdit
        Left = 16
        Top = 252
        Width = 73
        Height = 21
        DataField = 'ALIQMULTAQUEBRA'
        DataSource = DataCadastro
        TabOrder = 6
        Titulo.Left = 16
        Titulo.Top = 237
      ...
      object DBCheckBox1: TDBCheckBox
        ...
        Width = 169
        Height = 17
        Caption = 'Renovar automaticamente'
        DataField = 'FLAGRENOVARAUTOMATICO'
        DataSource = DataCadastro
        TabOrder = 7
        ValueChecked = 'Y'
        ValueUnchecked = 'N'
