inherited frmLst_ContaBancaria: TfrmLst_ContaBancaria
  ...
  inherited Panel1: TPanel
    inherited Panel3: TPanel
      inherited edtCodigo: TLabelDBEdit
        Titulo.Width = 38
        Titulo.Caption = 'Ag'#234'ncia'
        Titulo.ExplicitWidth = 38
      end
