inherited frmLst_CondicaoPagamento: TfrmLst_CondicaoPagamento
  ...
  inherited Panel1: TPanel
    ...
    inherited Panel3: TPanel
      ...
      object edtMaxParcela: TLabelDBEdit
        Left = 16
        Top = 224
        Width = 97
        Height = 21
        DataField = 'MAXPARCELAS'
        ...
        Titulo.Width = 94
        Titulo.Height = 13
        Titulo.Caption = 'M'#225'ximo de parcelas'
        IsNull = True
        PodeRepetir = False
      ...
      object grpTipoPagamento: TDBRadioGroup
        Left = 16
        Top = 96
        Width = 243
        Height = 105
        ...
        Values.Strings = (
          ...
          '4'
          '5')
        OnChange = grpTipoPagamentoChange
      end
      ...
      object LabelDBEdit1: TLabelDBEdit
        ...
        Titulo.Width = 121
        Titulo.Height = 13
        Titulo.Caption = 'Valor m'#237'nimo por parcelas'
        IsNull = True
        PodeRepetir = False
        CorPrincipal = clWhite
        CorSecundaria = 11592447
